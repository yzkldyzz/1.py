...
while majiang != []:
    while i < 4:
        ...
        # import random
        #
        # majiang = ['一万', '二万', '三万', '四万', '五万', '六万', '七万', '八万', '九万']
        # dic1 = dict()
        # dic2 = dict()
        # pygame.init()
        # window = pygame.display.set_mode((1000, 618))
        ...
        # pygame.display.update()
        # for i in range(14):
        #     image = pygame.image.load('images/majiang/' + majiang_type2[i] + '.jpg')
        #     image_rect = image.get_rect(center=(150 + 15 * i, 100))
        #     window.blit(image, image_rect)
        #     dic1[str(i)] = image_rect
        #     dic2[str(i)] = image
        #     pygame.display.update()
        ...
        #             for j in range(14):
        #                 print(event.pos)
        #                 print(dic1[str(j)].collidepoint(event.pos) is True)
        #                 if dic1[str(j)].collidepoint(event.pos):
        #                     rect = dic1[str(j)]
        #                     # dic2[str(j)].fill((255, 255, 255))
        #                     count = lst[0]
